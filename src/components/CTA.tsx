  ...
  return (
    <section id="cta" className="py-[120px] pb-20 relative z-10">
      <div className="max-w-[1120px] mx-auto px-7">
        <div className="bg-gradient-to-br from-indigo-900/40 via-purple-900/20 to-[#050505] border border-indigo-500/20 backdrop-blur-xl rounded-[32px] pt-8 md:pt-10 px-6 sm:px-8 md:px-12 pb-0 flex flex-col md:flex-row items-stretch justify-between gap-6 md:gap-12 relative overflow-hidden group">
          ...
          <div className="relative z-10 w-full md:w-[52%] flex flex-col items-start pt-2 pb-2 md:py-8">
          ...
          <div className="relative z-10 w-full md:w-[48%] flex justify-center md:justify-end items-end mt-auto pointer-events-none">
            <img 
              src="/alessandro2.png"
              alt="Alessandro" 
              referrerPolicy="no-referrer"
              className="h-[260px] sm:h-[320px] md:h-full w-auto object-contain object-bottom filter drop-shadow-2xl"
            />
          </div>
        </div>
      </div>
