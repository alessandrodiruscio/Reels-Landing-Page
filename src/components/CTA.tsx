  ...
  return (
    <section id="cta" className="py-[120px] pb-20 relative z-10">
      <div className="max-w-[1120px] mx-auto px-7">
        <div className="bg-gradient-to-br from-indigo-900/40 via-purple-900/20 to-[#050505] border border-indigo-500/20 backdrop-blur-xl rounded-[32px] pt-8 md:pt-10 px-8 md:px-12 pb-8 md:pb-0 flex flex-col md:flex-row items-stretch justify-between gap-8 md:gap-12 relative overflow-hidden group">
          ...
          <div className="relative z-10 md:w-[52%] flex flex-col items-start py-4 md:py-8">
          ...
          <div className="relative z-10 md:w-[48%] flex justify-center md:justify-end items-end self-stretch mt-auto pointer-events-none">
            <img 
              src="/alessandro2.png"
              alt="Alessandro" 
              referrerPolicy="no-referrer"
              className="max-h-[320px] md:max-h-none md:h-full w-auto object-contain object-bottom filter drop-shadow-2xl"
            />
          </div>
        </div>
      </div>
